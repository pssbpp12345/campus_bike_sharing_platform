...
/**
 * Campus Bike Sharing — Register page (separate from Login).
 *
 * - Wired to POST /api/auth/register
 * - On success → redirects to index.html?registered=1 so the login page can
...
export default function Register() {
  ...
  return (
    <div className="cbs-app">
      {/* Top Navigation — identical to login page */}
      ...
      <main className="cbs-main">
        ...
        <section className="cbs-right">
          <div className="cbs-card">
            ...
            <h2 className="cbs-card-title">Create Account</h2>
            <p className="cbs-card-subtitle">Sign up to get started</p>
